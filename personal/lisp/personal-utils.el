...
(global-set-key "%" 'personal-goto-matched-paren)
...
;;; Emacs has a similar built-in command(toggle-frame-fullscreen) in 24.4
(when-not (boundp 'toggle-frame-fullscreen)
